...
def create_random_samples(n: int) -> list:
    """
...
if __name__ == '__main__':
    sorted_samples = create_sorted_samples(20)
    reversed_samples = create_reversed_samples(20)
    random_samples = create_random_samples(20)
